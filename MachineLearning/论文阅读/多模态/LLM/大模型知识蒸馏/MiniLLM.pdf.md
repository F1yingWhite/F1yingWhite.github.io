...
> [!PDF|red] [Page.2](MachineLearning/论文阅读/多模态/LLM/大模型知识蒸馏/MiniLLM.pdf#page=2&selection=129,2,201,35&color=red)
>
...
> [!PDF|red] [Page.2](MachineLearning/论文阅读/多模态/LLM/大模型知识蒸馏/MiniLLM.pdf#page=2&selection=268,0,299,14&color=red)
>
...
> [!PDF|yellow] [Page.4](MachineLearning/论文阅读/多模态/LLM/大模型知识蒸馏/MiniLLM.pdf#page=4&selection=4,5,13,0&color=yellow)
>
...
> [!PDF|red] [Page.17](MachineLearning/论文阅读/多模态/LLM/大模型知识蒸馏/MiniLLM.pdf#page=17&selection=377,1,418,1&color=red)
>
...
> [!PDF|red] [Page.17](MachineLearning/论文阅读/多模态/LLM/大模型知识蒸馏/MiniLLM.pdf#page=17&selection=440,1,456,0&color=red)
>
> > log p(y|x) qθ (y|x)
>
