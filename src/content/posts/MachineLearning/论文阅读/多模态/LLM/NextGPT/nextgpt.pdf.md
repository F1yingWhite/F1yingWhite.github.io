---
title: "[[MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf|nextgpt]]"
description: ""
image: ""
tags:
  - 机器学习
...
> [!PDF|yellow] [Page.1](MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf#page=1&selection=44,1,48,41&color=yellow)
>
...
> [!PDF|yellow] [Page.1](MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf#page=1&selection=51,12,52,37&color=yellow)
>
> > Moreover, we introduce a modalityswitching instruction tuning (MosIT)
>
>引入了模态切换指令并且手动创建高质量数据集

> [!PDF|yellow] [Page.1](MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf#page=1&selection=103,0,105,51&color=yellow)
>
...
> [!PDF|red] [Page.1](MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf#page=1&selection=121,44,126,59&color=red)
>
...
> [!PDF|yellow] [Page.2](MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf#page=2&selection=103,44,105,43&color=yellow)
>
...
> [!PDF|yellow] [Page.3](MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf#page=3&selection=120,16,123,1&color=yellow)
>
...
> [!PDF|yellow] [Page.4](MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf#page=4&selection=0,35,4,97&color=yellow)
>
...
> [!PDF|red] [Page.4](MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf#page=4&selection=186,43,190,52&color=red)
>
...
> [!PDF|red] [Page.4](MachineLearning/论文阅读/多模态/LLM/NextGPT/nextgpt.pdf#page=4&selection=224,18,226,49&color=red)
>
